...
\begin{figure}
	\centering
		\includegraphics[scale=0.9]{figure61.png}
	\caption{Performance results obtained during the testing}
	\label{FIG:5}
\end{figure}
